...
import WigFloor1 from "/Users/catherineliu/dormlife/src/Components/DormNav/DormMap/Maps/Wig/Wig1.png";
import WigFloor2 from "/Users/catherineliu/dormlife/src/Components/DormNav/DormMap/Maps/Wig/Wig2.png";
...
const WigComponent = ({ activeTab, clickedArea, setClickedArea, showPopup, setShowPopup }) => {
    const [activeMap, setActiveMap] = useState(WigFloor1);

    const switchToFirstFloor = () => {
        setActiveMap(WigFloor1);
    };

    const switchToSecondFloor = () => {
        setActiveMap(WigFloor2);
    };
