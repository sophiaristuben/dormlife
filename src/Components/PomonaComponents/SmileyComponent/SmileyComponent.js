...
import SmileyFloor1 from "/Users/catherineliu/dormlife/src/Components/DormNav/DormMap/Maps/Smiley/Smiley12.png";
import SmileyFloor2 from "/Users/catherineliu/dormlife/src/Components/DormNav/DormMap/Maps/Smiley/Smiley12.png";
...
const SmileyComponent = ({ activeTab, clickedArea, setClickedArea, showPopup, setShowPopup }) => {
    const [activeMap, setActiveMap] = useState(SmileyFloor1);

    const switchToFirstFloor = () => {
        setActiveMap(SmileyFloor1);
    };

    const switchToSecondFloor = () => {
        setActiveMap(SmileyFloor2);
    };
