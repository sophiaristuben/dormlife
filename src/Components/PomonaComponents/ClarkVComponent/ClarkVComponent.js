...
import ClarkVFloor1 from "/Users/catherineliu/dormlife/src/Components/DormNav/DormMap/Maps/ClarkV/ClarkV1.png";
import ClarkVFloor2 from "/Users/catherineliu/dormlife/src/Components/DormNav/DormMap/Maps/ClarkV/ClarkV2.png";
...
const ClarkVComponent = ({ activeTab, clickedArea, setClickedArea, showPopup, setShowPopup }) => {
    const [activeMap, setActiveMap] = useState(ClarkVFloor1);

    const switchToFirstFloor = () => {
        setActiveMap(ClarkVFloor1);
    };

    const switchToSecondFloor = () => {
        setActiveMap(ClarkVFloor2);
    };
...
export default ClarkVComponent;
